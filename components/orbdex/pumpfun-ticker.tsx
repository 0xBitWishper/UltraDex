...
// Trending coins endpoint from Pump.fun
const PUMPFUN_TRENDING_URL = "https://frontend-api-v3.pump.fun/api/coins/top-runners"
...
export function PumpfunTrendingTicker() {
  const { data } = useSWR<PumpFunCoin[]>(PUMPFUN_TRENDING_URL, fetcher, {
